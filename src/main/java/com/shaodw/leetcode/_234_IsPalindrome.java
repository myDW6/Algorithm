...
public class _234_IsPalindrome {
    public boolean isPalindrome(CommonListNode head){
        if (head == null || head.next == null)
            return true;
        CommonListNode fast = head;
        CommonListNode slow = head;
    ...
    public static void main(String[] args) {
        CommonListNode head = new CommonListNode("a");
        head.next = new CommonListNode("b");
        head.next.next = new CommonListNode("b");
        head.next.next.next = new CommonListNode("a");
